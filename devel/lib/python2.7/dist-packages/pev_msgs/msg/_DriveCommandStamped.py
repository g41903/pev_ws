...
"""autogenerated by genpy from pev_msgs/DriveCommandStamped.msg. Do not edit."""
import sys
...
class DriveCommandStamped(genpy.Message):
  _md5sum = "1fd5d7f58889cefd44d29f6653240d0c"
  _type = "pev_msgs/DriveCommandStamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','pev_msgs/DriveCommand']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DriveCommandStamped, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.drive is None:
        self.drive = pev_msgs.msg.DriveCommand()
    else:
      self.header = std_msgs.msg.Header()
      self.drive = pev_msgs.msg.DriveCommand()
