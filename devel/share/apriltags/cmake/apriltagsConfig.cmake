...
if("TRUE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/ubuntu/PEV/pev_ws/src/pev_taf_demo/apriltags)
...
if(NOT "/home/ubuntu/PEV/pev_ws/devel/include;/home/ubuntu/PEV/pev_ws/src/pev_taf_demo/apriltags/include " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/PEV/pev_ws/devel/include;/home/ubuntu/PEV/pev_ws/src/pev_taf_demo/apriltags/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/PEV/pev_ws/src/pev_taf_demo/apriltags/${idir}'.  Ask the maintainer 'Aaron Walsman <awalsman@andrew.cmu.edu>' to fix it.")
    endif()
